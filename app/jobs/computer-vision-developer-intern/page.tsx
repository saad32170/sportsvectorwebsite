...
export default function ComputerVisionDeveloperInternPage() {
  useEffect(() => {
    window.scrollTo(0, 0)
  }, [])
  ...
  return (
    <div className="min-h-screen bg-green-900">
      <div className="max-w-4xl mx-auto px-6 py-20">
        ...
        {/* Job Header */}
        <div className="mb-12">
          <h1 className="text-8xl font-bold text-white mb-4">Computer Vision Developer Intern</h1>
          ...
          <div className="space-y-8">
            <div>
              ...
              <ul className="list-disc list-inside space-y-2 text-gray-300 ml-4">
                <li>Develop player tracking systems from match footage</li>
                <li>Build ball trajectory analysis models</li>
                <li>Create automated highlight generation systems</li>
                <li>Implement real-time action recognition for live matches</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-2 text-gray-300 ml-4">
                <li>You have experience with computer vision libraries (OpenCV, PIL, etc.)</li>
                <li>You're familiar with deep learning for image/video processing</li>
                <li>You enjoy working with visual data and video analysis</li>
                <li>You have an interest in sports technology and analytics</li>
                <li>You're comfortable with Python and neural network frameworks</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <ul className="list-disc list-inside space-y-2 text-gray-300 ml-4">
            <li>Advanced computer vision techniques for sports analysis</li>
            <li>Real-time video processing and analysis</li>
            <li>Building scalable vision pipelines</li>
            <li>Working with sports broadcast and match footage</li>
            <li>Integration of CV models with sports analytics platforms</li>
          </ul>
        </section>
